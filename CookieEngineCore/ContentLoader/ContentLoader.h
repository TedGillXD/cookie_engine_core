...
namespace Cookie::Content {
	...
	public:
		 ...
		 *  assetFilePath: path of the casset file that is going to be stored, can without extension
		 */
		static bool CreateAssetFileForMaterial(const Util::Array<std::string>& texturesPath, const std::string& assetFilePath);

		static bool CreateAssetFileForObject(const std::string& assetFilePath);
	};
